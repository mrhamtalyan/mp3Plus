    ...
    var pluginName = 'Calendar',
        ...
        template =  ''+
                        '<table border="0" class="calendar">'+
                            ...
                            '<thead>' +
                                '<tr>' +
                                    '<th colspan="1" class="sel" id="last"><div class="arrow"><i class="icon-left"></i></div></th>'+
                                    '<th colspan="5" class="sel" id="current"><span class="month year"></span></th>'+
                                    '<th colspan="1" class="sel" id="next"><div class="arrow"><i class="icon-right"></i></div></th>'+
                                '</tr>' +
    ...
    Plugin.prototype.renderEvents = function (events, elem) {
        ...
        for(var i=1; i<=daysInMonth[live_date.getMonth()]; i++){
            $.each(events.event, function(){
                ...
                var event_info = this.title;
                var event_link = this.link;
                ...
                if( event_date.getDate() == view_date.getDate()
                    ...
                    .addClass('holiday')
                    .empty()
                    .append('<span class="weekday">' + i + ' <div class="notification"><a href="'+ event_link +'">' + event_info + '</a></div></span>');
//                    .popover({
//                        'title': msg_evnts_hdr,

    ...
    init : function() {
        ...
        new jPlayerPlaylist({
        ...
        }, [
            {
                ...
                mp3:"mp3/co_co_jambo.mp3"
            },
            {
                title:"George Ellinas - Hornet",
                mp3:"mp3/hot_ringtone_2012.mp3"
            },
            {
                title:"Pitx - Black Rainbow",
                mp3:"mp3/tomorrowland.mp3"
            }
        ], {
            preload : "auto",
            swfPath: "mp3js",
...
jQuery(document).ready(function(){
    ...
    var evnts = function(){
        return {
            "event":
                [
                    {"date":"01/28/2014","title":"28", "link" : "/events-article.html"}
                    ,{"date":"01/07/2014","title":"2", "link" : "/events-article.html"}
                    ,{"date":"01/14/2014","title":"34", "link" : "/events-article.html"}
                    ,{"date":"01/12/2014","title":"11", "link" : "/events-article.html"}
                ]
        }
    };
...
//                alert("Current");
    ...
    var ts = new Date(2014, 2, 1);
    $('article.art1 .countdown').countdown({
        timestamp	: ts
    });
    ts = new Date(2014, 2, 2);
    ...
    ts = new Date(2014, 2, 10);
    $('article.art4 .countdown').countdown({
        timestamp	: ts
    });
    ts = new Date(2014, 3, 10);

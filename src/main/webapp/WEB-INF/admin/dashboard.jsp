    ...
    <div id=header-surround>
        <header id=header><img src="/adminpanel/img/logo.png" alt=Grape class=logo>
            ...
            <ul class=toolbox-header>
                <li><a rel=tooltip title="Create a User" class=toolbox-action
                       href="javascript:void(0);">
                    <span class=i-24-user-business></span></a>
                        ...
                        <div class=block-border>
                            ...
                            <form id=create-user-form class="block-content form" 
                                ...
                                <div class=_100><p><label for=username>Username</label><input 
                                        ...
                                        value=""/></p></div>
                                <div class=_50><p class=no-top-margin><label 
                                        for=firstname>Firstname</label><input
                                        id=firstname name=firstname class=required type=text 
                                        value=""/></p></div>
                                <div class=_50><p class=no-top-margin><label 
                                        for=lastname>Lastname</label><input
                                        id=lastname name=lastname class=required type=text 
                                        value=""/></p></div>
                                <div class=clear></div>
                                <div class=block-actions>
                                    <ul class=actions-left>
                                        <li><a class="close-toolbox button red" id=reset 
                                               href="javascript:void(0);">Cancel</a>
                                        </li>
                                    </ul>
                                    <ul class=actions-right>
                                        <li><input type=submit class=button value="Create the 
                                        User"></li>
                                    </ul>
                                </div>
                            </form>
                ...
                <li><a rel=tooltip title="Write a Message" class=toolbox-action 
                       href="javascript:void(0);"><span
                        class=i-24-inbox-document></span></a>
                    <div class=toolbox-content>
                        <div class=block-border>
                            ...
                            <form id=write-message-form class="block-content form" 
                                ...
                                <p class=inline-mini-label><label for=subject>Subject</label> 
                                    <input type=text name=subject></p>
                                <div class=_100><p class=no-top-margin><label 
                                        for=message>Message</label><textarea
                                        id=message name=message class=required rows=5 
                                        cols=40></textarea></p></div>
                                <div class=clear></div>
                                <div class=block-actions>
                                    <ul class=actions-left>
                                        <li><a class="close-toolbox button red" id=reset2 
                                               href="javascript:void(0);">Cancel</a>
                                        </li>
                                    </ul>
                                    <ul class=actions-right>
                                        <li><input type=submit class=button value="Send 
                                        Message"></li>
                                    </ul>
                                </div>
                            </form>
                ...
                <li><a rel=tooltip title="Create a Folder" class=toolbox-action 
                       href="javascript:void(0);"><span
                        class=i-24-folder-horizontal-open></span></a>
                    <div class=toolbox-content>
                        <div class=block-border>
                            ...
                            <form id=create-folder-form class="block-content form" 
                                ...
                                <div class=block-actions>
                                    <ul class=actions-left>
                                        <li><a class="close-toolbox button red" id=reset3 
                                               href="javascript:void(0);">Cancel</a>
                                        </li>
                                    </ul>
                                    <ul class=actions-right>
                                        <li><input type=submit class=button value="Create 
                                        Folder"></li>
                                    </ul>
                                </div>
                            </form>
...
">Administrator</a> ( <a
    ...
    <aside id=sidebar>
        <div id=search-bar>
            <form id=search-form name=search-form action="http://envato.stammtec
            .de/themeforest/grape/search.php"
    ...
    <div id=main role=main>
        ...
        <div id=main-content>
            <div class=container_12>
                <div class=grid_12><h1>Dashboard</h1>
                    <p>Here you have a quick overview of some features</p>
                    <div class="alert info"><span class=hide>x</span><strong>Hey there! 
                        Welcome to the professional and
                        flexible admin template &quot;Grape&quot;. I hope you enjoy your stay 
                        and please make sure, that
                        you visit the other pages.</strong></div>
                </div>
                <div class=grid_12>
                    <div class=block-border>
             ...
             <form id=validate-form class="block-content form" action="dashboard.jsp"
                   method=post><p
                                ...
                                class=required></p>
                            <p class=inline-mini-label><label for=category>Category</label> 
                            ...
                            <p class=inline-mini-label><label for=post>Post</label> <textarea 
                                    id=post name=post
                                    class=required rows=5
                                    cols=40></textarea>
                            </p> </p>
                            <div class=clear></div>
                            <div class=block-actions>
                ...
                <div class=grid_4>
                    <div class=block-border>
                        <div class=block-header><h1>What you should do</h1><span></span></div>
                        <div class=block-content>
                ...
                <div class=grid_4>
                    <div class=block-border>
                        <div class=block-header><h1>Overview-List</h1><span></span></div>
                        <div class=block-content><div class="alert info no-margin 
                        top">Youhave12 new support tickets.</div>
                            <ul class=overview-list>
                                <li><a href="javascript:void(0);"><span>8262</span> Total 
                                    Visits</a></li>
                                <li><a href="javascript:void(0);"><span>521</span> Today 
                                    Visits</a></li>
                                <li><a href="javascript:void(0);"><span>257</span> 
                                    Comments</a></li>
                                <li><a href="javascript:void(0);"><span>42</span> Support 
                                    Tickets</a></li>
                            </ul>
                        </div>
                    </div>
    ...
    <footer id=footer>
        <div class=container_12>
            <div class=grid_12>
                <div class="footer-icon align-center"><a class=top href="dashboard
                .html#top"></a></div>
            </div>
        </div>
    </footer>

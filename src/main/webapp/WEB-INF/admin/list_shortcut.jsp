...
<html class="no-js ie6 oldie" lang=en><html class="no-js ie7 oldie" lang=en> 
...
<div id=container>
                ...
                <li><a rel=tooltip title="Create a User" class=toolbox-action href="javascript:void(0);"><span
                    ...
                    <div class=toolbox-content>
                        <div class=block-border>
                            ...
                            <form id=create-user-form class="block-content form" action="list_shortcut.jsp" method=post>
                ...
                <li><a rel=tooltip title="Write a Message" class=toolbox-action href="javascript:void(0);"><span
                    ...
                    <div class=toolbox-content>
                        <div class=block-border>
                            ...
                            <form id=write-message-form class="block-content form" action="list_shortcut.jsp"
                ...
                <li><a rel=tooltip title="Create a Folder" class=toolbox-action href="javascript:void(0);"><span
                    ...
                    <div class=toolbox-content>
                        <div class=block-border>
                            ...
                            <form id=create-folder-form class="block-content form" action="list_shortcut.jsp"
    ...
    <aside id=sidebar>
        ...
        <section id=login-details><img class="img-left framed" src="/adminpanel/img/misc/avatar_small.png" alt="Hello Admin">
            ...
            <ul class=dropdown-username-menu>
                <li><a href="list_shortcut.jsp#">Profile</a></li>
                <li><a href="list_shortcut.jsp#">Settings</a></li>
                <li><a href="list_shortcut.jsp#">Messages</a></li>
                <li><a href="list_shortcut.jsp#">Logout</a></li>
            </ul>
        ...
        <nav id=nav>
            <ul class="menu collapsible shadow-bottom">
                ...
                <li class=expand><a href="javascript:void(0);" class=current><img
                        src="/adminpanel/img/icons/packs/fugue/16x16/clipboard-list.png">Lists<span class="badge grey">3</span></a>
                    <ul class=sub>
                        <li><a href="list_block.jsp">Block Lists</a></li>
                        <li><a href="list_shortcut.jsp" class=current>Shortcut List</a></li>
    ...
    <div id=main role=main>
        <div id=title-bar>
            <ul id=breadcrumbs>
                ...
                <li><a href="list_block.jsp" title=Lists>Lists</a></li>
        ...
        <div id=main-content>
            <div class=container_12>
                <div class=grid_12><h1>Shortcut List</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</p></div>
                <div class=grid_12>
                    <div class=block-border>
                        <div class=block-header><h1>Shortcut List</h1><span></span></div>
                        <div class=block-content>
                            <ul class=shortcut-list>
                                <li><a href="javascript:void(0);"> <img
                                        src="/adminpanel/img/icons/packs/onebit/48x48/onebit_19.png"> Write an Article </a></li>
                                <li><a href="javascript:void(0);"> <img
                                        src="/adminpanel/img/icons/packs/onebit/48x48/onebit_18.png"> User Manager </a></li>
                                <li><a href="javascript:void(0);"> <img
                                        src="/adminpanel/img/icons/packs/onebit/48x48/onebit_63.png"> Control Monitor </a></li>
                                <li><a href="javascript:void(0);"> <img
                                        src="/adminpanel/img/icons/packs/onebit/48x48/onebit_41.png"> Check the Mails </a></li>
                                <li><a href="javascript:void(0);"> <img
                                        src="/adminpanel/img/icons/packs/onebit/48x48/onebit_66.png"> Statistics </a></li>
                                <li><a href="javascript:void(0);"> <img
                                        src="/adminpanel/img/icons/packs/onebit/48x48/onebit_72.png"> Manage Console </a></li>
                                <li><a href="javascript:void(0);"> <img
                                        src="/adminpanel/img/icons/packs/onebit/48x48/onebit_85.png"> What to do </a></li>
                                <li><a href="javascript:void(0);"> <img
                                        src="/adminpanel/img/icons/packs/onebit/48x48/onebit_131.png"> Manage Images </a></li>
                            </ul>
                            <div class=clear></div>
                        </div>
                    </div>
    ...
    <footer id=footer>
        <div class=container_12>
            <div class=grid_12>
                <div class="footer-icon align-center"><a class=top href="list_shortcut.jsp#top"></a></div>
            </div>
        </div>
    </footer>
</div>

...
<div id=container>
                ...
                <li><a rel=tooltip title="Create a User" class=toolbox-action href="javascript:void(0);"><span
                    ...
                    <div class=toolbox-content>
                        <div class=block-border>
                            ...
                            <form id=create-user-form class="block-content form" action="notifications.jsp" method=post>
                ...
                <li><a rel=tooltip title="Write a Message" class=toolbox-action href="javascript:void(0);"><span
                    ...
                    <div class=toolbox-content>
                        <div class=block-border>
                            ...
                            <form id=write-message-form class="block-content form" action="notifications.jsp"
                                  method=post><p class=inline-mini-label><label for=recipient>Recipient</label> <input
                                    type=text name=recipient class=required></p>
                ...
                <li><a rel=tooltip title="Create a Folder" class=toolbox-action href="javascript:void(0);"><span
                    ...
                    <div class=toolbox-content>
                        <div class=block-border>
                            ...
                            <form id=create-folder-form class="block-content form" action="notifications.jsp"
                                  method=post><p class=inline-mini-label><label for=folder-name>Name</label> <input
                                    type=text name=folder-name class=required></p>
                                <div class=block-actions>
                                    <ul class=actions-left>
    ...
    <aside id=sidebar>
        ...
        <section id=login-details><img class="img-left framed" src="/adminpanel/img/misc/avatar_small.png" alt="Hello Admin">
            ...
            <ul class=dropdown-username-menu>
                <li><a href="notifications.jsp#">Profile</a></li>
                <li><a href="notifications.jsp#">Settings</a></li>
                <li><a href="notifications.jsp#">Messages</a></li>
                <li><a href="notifications.jsp#">Logout</a></li>
            </ul>
        ...
        <nav id=nav>
            <ul class="menu collapsible shadow-bottom">
                ...
                <li><a href="notifications.jsp" class=current><img
                        src="/adminpanel/img/icons/packs/fugue/16x16/application--exclamation.png">Notifications</a></li>
    ...
    <div id=main role=main>
        ...
        <div id=main-content>
            <div class=container_12>
                <div class=grid_12><h1>Notifications</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</p></div>
                <div class=grid_6>
                    <div class=block-border>
                        <div class=block-header><h1>Notifications Example</h1><span></span></div>
                        <div class=block-content><p>Just click a button to display a notification.</p>
                            <p>Only <strong>5 notifications</strong> will display at the <strong>same time</strong>.
                                This value is editable.</p></div>
                        <div class=block-content><p><a href="javascript:void(0);" id=notification-success class=button
                                                       style="width: 150px; text-align: center;">Success
                            Notification</a></p>
                            <p><a href="javascript:void(0);" id=notification-error class=button
                                  style="width: 150px; text-align: center;">Error Notification</a></p>
                            <p><a href="javascript:void(0);" id=notification-information class=button
                                  style="width: 150px; text-align: center;">Information Notification</a></p>
                            <p><a href="javascript:void(0);" id=notification-warning class=button
                                  style="width: 150px; text-align: center;">Warning Notification</a></p>
                            <p><a href="javascript:void(0);" id=notification-saved class=button
                                  style="width: 150px; text-align: center;">Saved Notification</a></p></div>
                    </div>
                </div>
    ...
    <footer id=footer>
        <div class=container_12>
            <div class=grid_12>
                <div class="footer-icon align-center"><a class=top href="notifications.jsp#top"></a></div>
            </div>
        </div>
    </footer>
</div>

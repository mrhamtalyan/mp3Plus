...
<div id=container>
                ...
                <li><a rel=tooltip title="Create a User" class=toolbox-action href="javascript:void(0);"><span
                    ...
                    <div class=toolbox-content>
                        <div class=block-border>
                            ...
                            <form id=create-user-form class="block-content form" action="list_contact.jsp" method=post>
                ...
                <li><a rel=tooltip title="Write a Message" class=toolbox-action href="javascript:void(0);"><span
                    ...
                    <div class=toolbox-content>
                        <div class=block-border>
                            ...
                            <form id=write-message-form class="block-content form" action="list_contact.jsp"
                ...
                <li><a rel=tooltip title="Create a Folder" class=toolbox-action href="javascript:void(0);"><span
                    ...
                    <div class=toolbox-content>
                        <div class=block-border>
                            ...
                            <form id=create-folder-form class="block-content form" action="list_contact.jsp"
    ...
    <aside id=sidebar>
        ...
        <section id=login-details><img class="img-left framed" src="/adminpanel/img/misc/avatar_small.png" alt="Hello Admin">
            ...
            <ul class=dropdown-username-menu>
                <li><a href="list_contact.jsp#">Profile</a></li>
                <li><a href="list_contact.jsp#">Settings</a></li>
                <li><a href="list_contact.jsp#">Messages</a></li>
                <li><a href="list_contact.jsp#">Logout</a></li>
            </ul>
            ...
            <ul class="menu collapsible shadow-bottom">
                ...
                <li class=expand><a href="javascript:void(0);" class=current><img
                    ...
                    <ul class=sub>
                        ...
                        <li><a href="list_contact.jsp" class=current>Contact List</a></li>
                    </ul>
                </li>
    ...
    <div id=main role=main>
        ...
        <div id=main-content>
            <div class=container_12>
                <div class=grid_12><h1>Contact List</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</p></div>
                <div class=grid_6>
                    <div class=block-border>
                        <div class=block-header><h1>Contact List</h1><span></span></div>
                ...
                <div class=grid_6>
                    <div class=block-border>
                        <div class=block-header><h1>Note</h1><span></span></div>
                        <div class=block-content><p>This is a very impressive method for displaying a lot of data.</p>
                            <p>You are not limited, to use the initial letters. Instead of using the letters, you can
                                use complete words or anything else.</p></div>
                    </div>
                </div>
    ...
    <footer id=footer>
        <div class=container_12>
            <div class=grid_12>
                <div class="footer-icon align-center"><a class=top href="list_contact.jsp#top"></a></div>
            </div>
        </div>
    </footer>
</div>

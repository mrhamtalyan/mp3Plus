...
<div id=container>
                ...
                <li><a rel=tooltip title="Create a User" class=toolbox-action href="javascript:void(0);"><span
                    ...
                    <div class=toolbox-content>
                        <div class=block-border>
                            ...
                            <form id=create-user-form class="block-content form" action="list_block.jsp" method=post>
                ...
                <li><a rel=tooltip title="Write a Message" class=toolbox-action href="javascript:void(0);"><span
                    ...
                    <div class=toolbox-content>
                        <div class=block-border>
                            ...
                            <form id=write-message-form class="block-content form" action="list_block.jsp" method=post>
                                <p class=inline-mini-label><label for=recipient>Recipient</label> <input type=text
                                                                                                         name=recipient
                                                                                                         class=required>
                                </p>
                ...
                <li><a rel=tooltip title="Create a Folder" class=toolbox-action href="javascript:void(0);"><span
                    ...
                    <div class=toolbox-content>
                        <div class=block-border>
                            ...
                            <form id=create-folder-form class="block-content form" action="list_block.jsp" method=post>
                                <p class=inline-mini-label><label for=folder-name>Name</label> <input type=text
                                                                                                      name=folder-name
                                                                                                      class=required>
                                </p>
                                <div class=block-actions>
    ...
    <aside id=sidebar>
        ...
        <section id=login-details><img class="img-left framed" src="/adminpanel/img/misc/avatar_small.png" alt="Hello Admin">
            ...
            <ul class=dropdown-username-menu>
                <li><a href="list_block.jsp#">Profile</a></li>
                <li><a href="list_block.jsp#">Settings</a></li>
                <li><a href="list_block.jsp#">Messages</a></li>
                <li><a href="list_block.jsp#">Logout</a></li>
            </ul>
        ...
        <nav id=nav>
            <ul class="menu collapsible shadow-bottom">
                ...
                <li class=expand><a href="javascript:void(0);" class=current><img
                    ...
                    <ul class=sub>
                        <li><a href="list_block.jsp" class=current>Block Lists</a></li>
    ...
    <div id=main role=main>
        ...
        <div id=main-content>
            <div class=container_12>
                <div class=grid_12><h1>Block Lists</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</p></div>
                <div class=grid_6>
                    <div class=block-border>
                        <div class=block-header><h1>Block List without Icon</h1><span></span></div>
                ...
                <div class=grid_6>
                    <div class=block-border>
                        <div class=block-header><h1>Block List with Icon</h1><span></span></div>
                        <div class=block-content>
                        ...
                        <div class="block-content dark-bg"><p>You can choose from more than <strong>+4.000
                            icons</strong>!</p></div>
                    </div>
                </div>
    ...
    <footer id=footer>
        <div class=container_12>
            <div class=grid_12>
                <div class="footer-icon align-center"><a class=top href="list_block.jsp#top"></a></div>
            </div>
        </div>
    </footer>
</div>

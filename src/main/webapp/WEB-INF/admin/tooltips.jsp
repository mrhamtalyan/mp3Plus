...
<div id=container>
                ...
                <li><a rel=tooltip title="Create a User" class=toolbox-action href="javascript:void(0);"><span
                    ...
                    <div class=toolbox-content>
                        <div class=block-border>
                            ...
                            <form id=create-user-form class="block-content form" action="tooltips.jsp" method=post>
                ...
                <li><a rel=tooltip title="Write a Message" class=toolbox-action href="javascript:void(0);"><span
                    ...
                    <div class=toolbox-content>
                        <div class=block-border>
                            ...
                            <form id=write-message-form class="block-content form" action="tooltips.jsp" method=post><p
                ...
                <li><a rel=tooltip title="Create a Folder" class=toolbox-action href="javascript:void(0);"><span
                    ...
                    <div class=toolbox-content>
                        <div class=block-border>
                            ...
                            <form id=create-folder-form class="block-content form" action="tooltips.jsp" method=post><p
    ...
    <aside id=sidebar>
        ...
        <section id=login-details><img class="img-left framed" src="/adminpanel/img/misc/avatar_small.png" alt="Hello Admin">
            ...
            <ul class=dropdown-username-menu>
                <li><a href="tooltips.jsp#">Profile</a></li>
                <li><a href="tooltips.jsp#">Settings</a></li>
                <li><a href="tooltips.jsp#">Messages</a></li>
                <li><a href="tooltips.jsp#">Logout</a></li>
            </ul>
        ...
        <nav id=nav>
            <ul class="menu collapsible shadow-bottom">
                ...
                <li><a href="tooltips.jsp" class=current><img src="/adminpanel/img/icons/packs/fugue/16x16/ui-tooltip-balloon.png">Tooltips</a>
                </li>
    ...
    <div id=main role=main>
        ...
        <div id=main-content>
            <div class=container_12>
                <div class=grid_12><h1>Tooltips</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor.</p></div>
                <div class=grid_4>
                    <div class=block-border>
                        <div class=block-header><h1>Tooltip Top</h1><span></span></div>
                        <div class=block-content><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                            eiusmod.</p>
                            <p><a href="javascript:void(0);" rel=tooltip-top
                                  title="Lorem ipsum dolor sit amet."><strong>Hover over this link.</strong></a></p>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p></div>
                    </div>
                </div>
                <div class=grid_4>
                    <div class=block-border>
                        <div class=block-header><h1>Tooltip Right</h1><span></span></div>
                        <div class=block-content><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                            eiusmod.</p>
                            <p><a href="javascript:void(0);" rel=tooltip-right
                                  title="Lorem ipsum dolor sit amet."><strong>Hover over this link.</strong></a></p>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p></div>
                    </div>
                </div>
                <div class=grid_4>
                    <div class=block-border>
                        <div class=block-header><h1>Tooltip Bottom</h1><span></span></div>
                        <div class=block-content><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                            eiusmod.</p>
                            <p><a href="javascript:void(0);" rel=tooltip-bottom
                                  title="Lorem ipsum dolor sit amet."><strong>Hover over this link.</strong></a></p>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p></div>
                    </div>
                </div>
                <div class=grid_4>
                    <div class=block-border>
                        <div class=block-header><h1>Tooltip Left</h1><span></span></div>
                        <div class=block-content><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                            eiusmod.</p>
                            <p><a href="javascript:void(0);" rel=tooltip-left
                                  title="Lorem ipsum dolor sit amet."><strong>Hover over this link.</strong></a></p>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p></div>
                    </div>
                </div>
                <div class=grid_4>
                    <div class=block-border>
                        <div class=block-header><h1>HTML Tooltip</h1><span></span></div>
                        <div class=block-content><p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
                            eiusmod.</p>
                            <p><a href="javascript:void(0);" rel=tooltip-html
                                  title="This is a &lt;b&gt;bold&lt;/b&gt; text&lt;br&gt;This is an &lt;i&gt;italic&lt;/i&gt; text&lt;br&gt;This is an &lt;u&gt;underline&lt;/u&gt; text"><strong>Hover
                                over this link.</strong></a></p>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod.</p></div>
                    </div>
                </div>
    ...
    <footer id=footer>
        <div class=container_12>
            <div class=grid_12>
                <div class="footer-icon align-center"><a class=top href="tooltips.jsp#top"></a></div>
            </div>
        </div>
    </footer>
</div>

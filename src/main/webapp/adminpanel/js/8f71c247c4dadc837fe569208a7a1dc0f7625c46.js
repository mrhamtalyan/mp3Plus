if (!document.createElement("canvas").getContext) {
    (function () {
        ...
        function p(i, G, m, j) {
            i.currentPath_.push({type: "bezierCurveTo", cp1x: G.x, cp1y: G.y, cp2x: m.x, cp2y: m.y, x: j.x, y: j.y});
            i.currentX_ = j.x;
            i.currentY_ = j.y
        }
        ...
        l.arc = function (M, K, L, H, j, m) {
            ...
            this.currentPath_.push({type: Q, x: G.x, y: G.y, radius: L, xStart: J.x, yStart: J.y, xEnd: I.x, yEnd: I.y})
        };
            ...
            if (!ag) {
                ...
                if (typeof this.fillStyle == "object") {
                    ...
                    if (P.type_ == "gradient") {
                        ...
                        var j = Y.x - aq.x;
                        var G = Y.y - aq.y;
                        aj = {x: (ao.x - aq.x) / j, y: (ao.y - aq.y) / G};
                        j /= this.arcScaleX_ * a;
                        G /= this.arcScaleY_ * a;
                        var ai = v.max(j, G);
                        ad = 2 * P.r0_ / ai;
...
(function (c, l) {
    ...
    c.extend(c.ui.dialog, {
        version: "1.8.15", uuid: 0, maxZ: 0, getTitleId: function (a) {
            a = a.attr("id");
            if (!a) {
                this.uuid += 1;
                a = this.uuid
    ...
    d.extend(M.prototype, {
        ...
        _checkOffset: function (a, b, c) {
            var e = a.dpDiv.outerWidth(), f = a.dpDiv.outerHeight(), h = a.input ? a.input.outerWidth() :
                0, i = a.input ? a.input.outerHeight() : 0,
        ...
        _updateAlternate: function (a) {
            ...
            if (b) {
                var c = this._get(a,
                    "altFormat") || this._get(a, "dateFormat"), e = this._getDate(a),
        ...
        _generateHTML: function (a) {
            ...
            var c = this._get(a, "isRTL"), e = this._get(a, "showButtonPanel"), f = this._get(a, "hideIfNoPrevNext"),
                ...
                u = this._daylightSavingAdjust(!a.currentDay ? new Date(9999,
                    9, 9) : new Date(a.currentYear, a.currentMonth, a.currentDay)), k = this._getMinMaxDate(a, "min"),
...
jQuery.effects || function (f, j) {
    ...
    f.extend(f.effects, {
        version: "1.8.15", save: function (c, a) {
    ...
    $.fn.dataTable = function (oInit) {
        ...
        this.fnFilter = function (sInput, iColumn, bRegex, bSmart, bShowGlobal) {
            ...
            if (typeof iColumn == "undefined" || iColumn === null) {
                _fnFilterComplete(oSettings, {sSearch: sInput, bRegex: bRegex, bSmart: bSmart}, 1);
        ...
        function _fnAddData(oSettings, aDataSupplied) {
            ...
            var oData = {nTr: null, _iId: oSettings.iNextId++, _aData: aDataIn, _anHidden: [], _sRowStripe: ""};
        ...
        function _fnGatherData(oSettings) {
            var iLoop, i, iLen, j, jLen, jInner, nTds, nTrs, nTd, aLocalData, iThisIndex, iRow, iRows, iColumn,
                iColumns, sNodeName;
            ...
            for (iColumn = 0, iColumns = oSettings.aoColumns.length; iColumn < iColumns; iColumn++) {
                ...
                var bAutoType = oSettings.aoColumns[iColumn]._bAutoType,
                    ...
                    bVisible = oSettings.aoColumns[iColumn].bVisible, nCell, sThisType, sRendered, sValType;
        ...
        function _fnDraw(oSettings) {
            ...
            var nAddFrag = document.createDocumentFragment(), nRemoveFrag = document.createDocumentFragment(), nBodyPar,
                nTrs;
            if (oSettings.nTBody) {
        ...
        function _fnFeatureHtmlTable(oSettings) {
            ...
            var nScroller = document.createElement("div"), nScrollHead = document.createElement("div"),
                nScrollHeadInner = document.createElement("div"), nScrollBody = document.createElement("div"),
                nScrollFoot = document.createElement("div"), nScrollFootInner = document.createElement("div"),
        ...
        function _fnScrollDraw(o) {
            var nScrollHeadInner = o.nScrollHead.getElementsByTagName("div")[0],
                nScrollHeadTable = nScrollHeadInner.getElementsByTagName("table")[0], nScrollBody = o.nTable.parentNode,
                i, iLen, j, jLen, anHeadToSize, anHeadSizers, anFootSizers, anFootToSize, oStyle, iVis, iWidth,
                aApplied = [], iSanityWidth;
        ...
        function _fnSort(oSettings, bApplyClasses) {
            var iDataSort, iDataType, i, iLen, j, jLen, aaSort = [], aiOrig = [], oSort = _oExt.oSort,
                aoData = oSettings.aoData, aoColumns = oSettings.aoColumns;
        ...
        function _fnUpdateInfo(oSettings) {
            ...
            var iStart = oSettings._iDisplayStart + 1, iEnd = oSettings.fnDisplayEnd(),
                ...
                sMax = oSettings.fnFormatNumber(iMax), sTotal = oSettings.fnFormatNumber(iTotal), sOut;
            if (oSettings.oScroll.bInfinite) {
        ...
        function _fnCalculateColumnWidths(oSettings) {
            ...
            if (iColums == oHeaders.length && iUserInputs === 0 && iVisibleColumns == iColums && oSettings.oScroll.sX === "" && oSettings.oScroll.sY === "") {
                ...
                var nCalcTmp = oSettings.nTable.cloneNode(false), nTheadClone = oSettings.nTHead.cloneNode(true),
                    nBody = document.createElement("tbody"), nTr = document.createElement("tr"), nDivSizing;
        ...
        function _fnGetTdNodes(oSettings, iIndividualRow) {
            ...
            for (iRow = iStart; iRow < iEnd; iRow++) {
                ...
                if (oData.nTr !== null) {
                    anTds = [];
                    for (iColumn = 0, iColumns = oData.nTr.childNodes.length; iColumn < iColumns;
                         iColumn++) {
                ...
                for (j = 0, jLen = nTrs[i].childNodes.length; j < jLen; j++) {
                    ...
                    if (nCell.nodeName.toUpperCase() == "TD" || nCell.nodeName.toUpperCase() == "TH") {
                        ...
                        for (l = 0; l < iColspan; l++) {
                            for (k = 0; k < iRowspan; k++) {
                                aLayout[i + k][iColShifted + l] = {cell: nCell, unique: iColspan == 1 ? true : false};
...
(function (i, wa, p) {
    ...
    o.oPagination = {
        two_button: {
            ...
            fnInit: function (g, l, r) {
                var s = p.createElement("span"), w = p.createElement("span"), y = p.createElement("span"),
                    G = p.createElement("span"), x = p.createElement("span");
                ...
                if (g.aanFeatures.p) {
                    var r = o.oPagination.iFullNumbersShowPages, s = Math.floor(r / 2),
                        w = Math.ceil(g.fnRecordsDisplay() / g._iDisplayLength),
                        y = Math.ceil(g._iDisplayStart / g._iDisplayLength) + 1, G =
                            "", x, v = g.oClasses;
                    if (w < r) {
                        s = 1;
                        x = w
    ...
    o._oExternConfig = {iNextUnique: 0};
    i.fn.dataTable = function (g) {
        function l() {
            ...
            this.fnServerData = function (a, b, c, d) {
                d.jqXHR = i.ajax({
                    url: a, data: b, success: c, dataType: "json", cache: false, error: function (f, e) {
        ...
        function s(a) {
            ...
            if (a.bInitialised === false) setTimeout(function () {
                ...
                if (a.oFeatures.bSort) R(a); else if (a.oFeatures.bFilter) M(a, a.oPreviousSearch);
                else {
                ...
                if (a.sAjaxSource !== null && !a.oFeatures.bServerSide) a.fnServerData.call(a.oInstance, a.sAjaxSource, [], function (f) {
                    ...
                    K(a, false);
                    w(a, f)
                }, a); else if (!a.oFeatures.bServerSide) {
                    K(a, false);
                    w(a)
                }
            }
        ...
        function v(a, b) {
            ...
            for (var f,
                ...
                if (c._bAutoType && c.sType != "string") {
                    ...
                    if (f !== null && f !== "") {
                        f = fa(f);
                        if (c.sType === null) c.sType = f; else if (c.sType != f) c.sType = "string"
                    }
                }
            }
                ...
                if (j || m || e || !k) {
                    ...
                    for (c = a.aoData.length; b < c; b++) {
                        ...
                        if (j && a.aoColumns[d].sType != "string") {
                            ...
                            if (q !== "") {
                                q = fa(q);
                                if (a.aoColumns[d].sType === null) a.aoColumns[d].sType = q; else if (a.aoColumns[d].sType != q) a.aoColumns[d].sType = "string"
                            }
                        }
                        if (m) {
        ...
        function ba(a) {
            if (a.oFeatures.bSort) R(a, a.oPreviousSearch); else if (a.oFeatures.bFilter) M(a, a.oPreviousSearch); else {
                E(a);
                C(a)
            }
        }
        ...
        function za(a) {
            if (a.bAjaxDataGet) {
                ...
                c.push({name: "sColumns", value: ha(a)});
        ...
        function Fa(a) {
            ...
            var b = p.createElement("div"), c = p.createElement("div"), d = p.createElement("div"),
                f = p.createElement("div"), e = p.createElement("div"), h = p.createElement("div"),
                j = a.nTable.cloneNode(false),
                k = a.nTable.cloneNode(false), m = a.nTable.getElementsByTagName("thead")[0],
            ...
            a.aoDrawCallback.push({fn: Ia, sName: "scrolling"});
        ...
        function Ia(a) {
            var b = a.nScrollHead.getElementsByTagName("div")[0], c = b.getElementsByTagName("table")[0],
                d = a.nTable.parentNode, f, e, h, j, k, m, t, q, I = [];
            ...
            if (a.oScroll.sX === "") {
                ...
                "") a.nTable.style.width = u(a.oScroll.sXInner); else if (f == i(d).width() && i(d).height() < i(a.nTable).height()) {
        ...
        function na(a, b) {
            ...
            for (var d = a.__nTmpFilter, f = 0, e = a.aoColumns.length; f < e; f++) if (a.aoColumns[f].bSearchable) c += ma(b[f], a.aoColumns[f].sType) + "  ";
            if (c.indexOf("&") !== -1) {
                d.innerHTML = c;
        ...
        function ma(a, b) {
            if (typeof o.ofnSearch[b] == "function") return o.ofnSearch[b](a); else if (b == "html") return a.replace(/\n/g, " ").replace(/<.*?>/g, ""); else if (typeof a == "string") return a.replace(/\n/g, " "); else if (a === null) return "";
            return a
        }
        ...
        function R(a, b) {
            ...
            a.bSorted = true;
            if (a.oFeatures.bFilter) M(a, a.oPreviousSearch, 1); else {
                a.aiDisplay = a.aiDisplayMaster.slice();
                a._iDisplayStart = 0;
                E(a);
                C(a)
        ...
        function Ga(a) {
            ...
            if (typeof a.aanFeatures.i == "undefined") {
                a.aoDrawCallback.push({fn: Na, sName: "information"});
        ...
        function Na(a) {
            if (!(!a.oFeatures.bInfo || a.aanFeatures.i.length === 0)) {
                var b = a._iDisplayStart + 1, c = a.fnDisplayEnd(), d = a.fnRecordsTotal(), f = a.fnRecordsDisplay(),
                    e = a.fnFormatNumber(b), h = a.fnFormatNumber(c), j =
        ...
        function ea(a) {
            ...
            if (f == h.length && b === 0 && d == f && a.oScroll.sX === "" && a.oScroll.sY === "") for (e = 0; e < a.aoColumns.length; e++) {
                ...
                for (e = d = 0; e < f; e++) {
                    var j = a.aoColumns[e];
                    if (j.bVisible && j.sWidthOrig !== null && j.sWidthOrig !== "") h[e - d].style.width = u(j.sWidthOrig); else if (j.bVisible) h[e - d].style.width = ""; else d++
                }
                for (e = 0; e < f; e++) if (a.aoColumns[e].bVisible) {
                    d = Pa(a, e);
                    if (d !== null) {
                ...
                if (a.oScroll.sX !== "" && a.oScroll.sXInner !==
                    "") b.style.width = u(a.oScroll.sXInner); else if (a.oScroll.sX !== "") {
                    b.style.width = "";
        ...
        function Va(a, b) {
            ...
            for (var c =
                0; c < a.length; c++) if (a[c] != b[c]) return 2;
            return 0
        }
        ...
        function ra(a, b) {
            for (var c = -1, d =
                0, f = a.length; d < f; d++) if (a[d] == b) c = d; else a[d] > b && a[d]--;
            c != -1 && a.splice(c, 1)
        }
                ...
                for (k = b[d].childNodes.length; f < k; f++) {
                    ...
                    if (c.nodeName.toUpperCase() == "TD" || c.nodeName.toUpperCase() == "TH") {
                        ...
                        for (h = 0; h < q; h++) for (e = 0; e < I; e++) {
                            a[d + e][m + h] = {cell: c, unique: q == 1 ? true : false};
                            a[d + e].nTr = b[d]
                        }
                    }
                }
        ...
        this.fnGetPosition = function (a) {
            ...
            if (c == "TR") return U(b, a); else if (c == "TD" || c == "TH") {
                c = U(b, a.parentNode);
            ...
            if (i.isArray(a) && typeof a == "object") {
                ...
                if (e.aoColumns[c].fnRender !== null) {
                    a = e.aoColumns[c].fnRender({
                        iDataRow: b, iDataColumn: c, aData: e.aoData[b]._aData,
                        oSettings: e
                    });
        ...
        for (var ua in o.oApi) if (ua) this[ua] = r(ua);
        ...
        return this.each(function () {
            ...
            if (this.nodeName.toLowerCase() != "table") J(e, 0, "Attempted to initialise DataTables on a node which is not a table: " + this.nodeName); else {
                ...
                if (typeof g !=
                    ...
                    }); else e.oFeatures.bDeferRender && e.aoDrawCallback.push({fn: T, sName: "defer_sort_classes"});
                    ...
                    if (typeof g.bStateSave != "undefined") {
                        ...
                        Ta(e, g);
                        e.aoDrawCallback.push({fn: sa, sName: "state_save"})
                    }
                ...
                if (typeof g.aoColumnDefs != "undefined") for (a = g.aoColumnDefs.length - 1; a >= 0; a--) {
                    ...
                    for (d = m.length; c < d; c++) if (typeof m[c] == "number" && m[c] >= 0) {
                        ...
                        "number" && m[c] < 0) x(e, e.aoColumns.length + m[c], g.aoColumnDefs[a]); else if (typeof m[c] == "string") {
                        b = 0;
...
$.fn.sliderNav = function (b) {
    ...
    $(".slider-nav a", d).mouseover(function (k) {
        ...
        $(m).addClass("selected");
        $(".slider-content", d).stop().animate({scrollTop: "+=" + l + "px"});
        if (g.debug) {
            $("#debug span", d).html(j)
        }
    });
    if (g.arrows) {
        ...
        $(".slide-down", d).click(function () {
            $(".slider-content", d).animate({scrollTop: "+=" + a + "px"}, 500)
        });
...
(function (c) {
    ...
    b.prototype = {
        show: function () {
            ...
            if (g && this.enabled) {
                ...
                switch (h.charAt(0)) {
                    case"n":
                        e = {top: j.top + j.height + this.options.offset, left: j.left + j.width / 2 - d / 2};
                        break;
                    case"s":
                        e = {top: j.top - i - this.options.offset, left: j.left + j.width / 2 - d / 2};
                        break;
                    case"e":
                        e = {top: j.top + j.height / 2 - i / 2, left: j.left - d - this.options.offset};
                        break;
                    case"w":
                        e = {top: j.top + j.height / 2 - i / 2, left: j.left + j.width + this.options.offset};
                        break
                }
                if (h.length == 2) {
                    if (h.charAt(1) == "w") {
                ...
                if (this.options.fade) {
                    ...
                    f.css({visibility: "visible", opacity: this.options.opacity})
                }
            }
        }, hide: function () {
            if (this.options.fade) {
    ...
    c.fn.tipsy = function (h) {
        ...
        if (h.trigger != "manual") {
            var d = h.live ? "live" : "bind", i = h.trigger == "hover" ? "mouseenter" : "focus",
    ...
    a.fn.slideList = function (b) {
        return a(this).each(function () {
            ...
            a(this).hover(function () {
                a(this).animate({paddingLeft: parseInt(d) + parseInt(5) + "px"}, 130)
            }, function () {
                bc_hover = a(this).css("background-color");
                a(this).animate({paddingLeft: d, paddingRight: c}, 130)
            })
        })
    }
})(jQuery);
(function (a) {
    ...
    a.fn.alertBox.defaults = {type: "info", position: "top", noMargin: true}
})(jQuery);
(function (a) {
